...
plot_learning_curve(estimator, title, train_anime_X, train_anime_Y, ylim=(0.6, 0.9), cv=cv, n_jobs=4, image_loc=image_loc)
...
plot_learning_curve(estimator, title, train_heart_X, train_heart_Y, ylim=(0.55, 1.01), cv=cv, n_jobs=4, image_loc=image_loc)
